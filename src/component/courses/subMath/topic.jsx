    ...
    <>
      <div className="bg-[#F0F8FF] py-6 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="text-center my-4">
            <motion.button 
        ...
        <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
          ...
          <main className="px-4 py-4 sm:px-6 lg:px-8 space-y-16">
              ...
              >
                ...
                >
                  ...
                  >
                    <img
                      src={`${import.meta.env.VITE_APP_URL}${ele.image}`}
                      className="object-contain max-h-[350px] drop-shadow-lg"
                      alt={ele.title}
                    />
                  </motion.div>
                </motion.div>
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="text-center text-lg font-bold my-4">
                So why wait? To avail a Free Trial Class for Science Online
                Tutoring
              </motion.div>
              <motion.div variants={fadeInUp} className="text-center my-4">
