    ...
    >
      <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8 ">
        ...
        <div className=" py-4">
          ...
          <p className="my-4 font-semibold text-[16px] text-gray-500">
            One is given the respective points for choosing the correct answer,
            0 points for not answering, and a quarter of the respective points
            are taken off for choosing a wrong answer.
          </p>
          <p className="my-4 font-semibold text-[16px] text-gray-500">
          ...
          <section>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div>
                  <h3 className="font-semibold text-lg">
                    5. Each participant receives a competition booklet, an
                    answer form, scratch paper and pencil.
                  </h3>
                </div>
                <div>
                  <h3 className="font-semibold text-lg">
                    6. No aids other than writing instruments and paper will be
                    allowed. In particular, no calculators will be allowed on
                    any part of the competition, and any cell phones must be
                    turned off.
                  </h3>
                </div>
              </div>
