  ...
  return (
    <div className="py-14 px-4 md:px-20" id="shsat">
      <div className="max-w-7xl mx-auto">
        ...
        {/* ===== HERO SECTION & BUTTON (3D Hover Effect) ===== */}
        <motion.div 
          className="bg-[#F0F8FF] p-8 rounded-2xl shadow-xl mb-10"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={fadeInUp}
        ...
        >
          ...
          <div className="text-center font-semibold text-lg mb-2">
            So why wait? To avail a Free Trial Class for SHSAT Test Prep Online Tutoring, &nbsp; 
            <motion.span
              onClick={() => navigate("/contact")}
        ...
        {/* ===== ALL ABOUT SHSAT (Dynamic Staggered Section) ===== */}
        {(safeData.aboutMainHeading || (safeData.aboutItems && safeData.aboutItems.length > 0)) && (
          ...
          >
            {safeData.aboutMainHeading && (
              <motion.h2 variants={fadeInUp} className="text-2xl font-bold mb-4 text-blue-800">
                {safeData.aboutMainHeading}
              </motion.h2>
            )}
            ...
            {safeData.aboutItems && safeData.aboutItems.length > 0 &&
              safeData.aboutItems.map((item, index) => (
                <motion.div key={index} className="mb-6 last:mb-0" variants={fadeInUp}>
                  {item.title && (
                    <h3 className="text-xl font-bold mt-6 mb-2 text-blue-700">
                      {item.title}
                    </h3>
        ...
        {/* ===== CTA (Pop Up Animation) ===== */}
        <motion.div 
          className="bg-blue-900 text-white p-10 rounded-2xl text-center"
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-white cursor-pointer text-blue-900 px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition shadow-lg"
          >
            Book Free Trial Class
          </motion.button>
        </motion.div>
