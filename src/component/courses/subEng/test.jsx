    ...
    <div className="container max-w-7xl mx-auto">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
        <p className="text-lg text-gray-700 leading-relaxed text-center">
          ...
          schools, the ISEE is accepted by over 1,200 independent schools around
          the world. Available in both online and paper modalities and in both
          open and closed (invitation only) administrations, the ISEE is the
          most advanced tool available to find your future students.
        </p>
        <p className="text-lg text-gray-700 leading-relaxed text-center">
          The ISEE test is the Independent School Entrance Examination, an
          admissions test used by private schools for grades 2–12. It assesses a
          student’s academic skills and consists of five sections: Verbal
          Reasoning, Quantitative Reasoning, Reading Comprehension, Mathematics
          Achievement, and an unscored essay . Different levels of the test are
          offered for different grade levels: Primary (2–4), Lower (5–6), Middle
          (7–8), and Upper (9–12) .
        </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 border border-blue-100">
              ...
              <p className="text-gray-700">
                Primary, Lower, Middle, and Upper, based on the grade a student
                is applying for.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-md p-6 border-2 border-indigo-200">
              ...
              <ul className="text-gray-700 space-y-1 text-sm">
                ...
                <li>• Mathematics Achievement, and</li>
                <li>• an Essay.</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 border border-purple-100">
              <h3 className="text-xl font-bold text-purple-700 mb-3">Essay:</h3>
              <p className="text-gray-700">
                The essay is unscored but is sent to the schools along with the
