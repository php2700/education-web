    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800 overflow-hidden">
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-20 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
          ...
          {/* Hero Image / Illustration (Floating Effect) */}
          <div className="md:w-2/5 flex justify-center">
            <div className="relative">
              <motion.div 
                animate={{ scale: [1, 1.1, 1], opacity: [0.3, 0.5, 0.3] }}
                transition={{ duration: 4, repeat: Infinity }}
                className="absolute inset-0 bg-blue-500 blur-3xl opacity-30 rounded-full"
              ></motion.div>
              
              <motion.img
                initial={{ y: 0 }}
                animate={{ y: [-15, 15, -15] }} // Floating Animation
      ...
      <section
        id="methodology"
        className="bg-[#F0F8FF] py-20 px-6 bg-white relative z-10"
        style={{
          backgroundImage: `url(${backgroundImage})`,
          backgroundSize: "contain",
          backgroundPosition: "center",
          ...
          >
            ...
            {methodologyData?.map((ele, index) => (
              <motion.div 
                ...
                className="flex flex-col items-center text-center p-6 bg-blue-50 rounded-xl hover:shadow-lg transition border border-blue-100 h-full cursor-pointer"
              >
                <div className="w-14 h-14 bg-white text-blue-600 rounded-full flex items-center justify-center mb-4 shadow-sm">
                  <img
                    src={`${import.meta.env.VITE_APP_URL}${ele?.image}`}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.div 
              ...
              className="bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-blue-600 transition duration-300"
            >
              <div className="bg-blue-50 p-6 flex items-center gap-4">
                <div className="bg-blue-600 p-3 rounded-lg text-white shadow-xl">
                  <Calculator size={24} />
            ...
            <motion.div 
              variants={fadeInUp}
              whileHover={{ y: -10, scale: 1.02, boxShadow: "0px 20px 40px rgba(0,0,0,0.15)" }}
              className="bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-teal-600 transition duration-300"
            >
              <div className="bg-teal-50 p-6 flex items-center gap-4">
                <div className="bg-teal-600 p-3 rounded-lg text-white shadow-xl">
                  <Microscope size={24} />
            ...
            <motion.div 
              variants={fadeInUp}
              whileHover={{ y: -10, scale: 1.02, boxShadow: "0px 20px 40px rgba(0,0,0,0.15)" }}
              className="bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-indigo-600 transition duration-300"
            >
              <div className="bg-indigo-50 p-6 flex items-center gap-4">
                <div className="bg-indigo-600 p-3 rounded-lg text-white shadow-xl">
                  <BookOpen size={24} />
